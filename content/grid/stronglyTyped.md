...
Basic simple usage of **new Matrix** *Grid* with data loaded asynchronously from *REST* service, simple columns enchanced with typed context by using custom implementation of `ContentCellTemplateDirective` => `AddressContentCellTemplateDirective`. This allows typechecking when creating templates for columns.
...
@SAMPLE#strongly-typed-grid&grid/StronglyTypedComponent@